...
def measure(image_ref: str) -> dict[str, str]:
    ...
    script = (
        "set -eu; "
        "python -c 'import pydantic, ux_creator; "
        'print("ux_creator=" + ux_creator.__version__); '
    ...
    for line in result.stdout.splitlines():
        line = line.strip()
        if line.startswith("ux_creator="):
            values["ux_creator"] = line.removeprefix("ux_creator=")
    ...
    required = {"ux_creator", "pydantic", "python", "git", "uv"}
