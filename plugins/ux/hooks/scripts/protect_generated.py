#!/usr/bin/env python3
"""Reject writes to generated UX projections and reports.
...
def main() -> int:
    ...
    if _is_artifact_write(payload):
        print(
            "generated artifacts (mermaid/plantuml/xstate/scxml/stories/odi,"
            " ux-report.json) are projections of the contract;"
            " regenerate them via ux_author or `python -m ux_creator author`,"
